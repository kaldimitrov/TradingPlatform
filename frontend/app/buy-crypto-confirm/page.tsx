                                    ...
                                    <div className="content-tab">
                                        <div className="content-inner buy-crypto__main" style={{ display: `block` }}>
                                            ...
                                            <div className="main info">
                                                ...
                                                <p>
                                                    You are about to receive 1.356 BTC to your wallet address. Please confirm the information below is correct.
                                                </p>
                                                <ul className="list">
                                                    <li>
                                                        <div className="icon">
                                                        ...
                                                        <div className="content">
                                                            <p>Pay</p>
                                                            <h6 className="price">$10,000.00</h6>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div className="content">
                                                            <p>Provider</p>
                                                            <h6 className="price">TradingPlatform</h6>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="align-end">
                                                <div className="group-button">
                                                    ...
                                                    <button className="submit btn-action ml-8px">Let’s move on!</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
